...
public class TestDataUtil {
    ...
    public static List<Item> getTestItems() {
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            item.setCreatedAt(LocalDateTime.of(2020, Month.JANUARY, 01, 0, 0, 0));
            item.setDoneAt(LocalDateTime.of(2020, Month.JANUARY, 01, 5, 0, 0));
            item.setDeletedAt(LocalDateTime.of(2020, Month.JANUARY, 01, 10, 0, 0));
